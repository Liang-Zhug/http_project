...
void SendQuery(const std::string &queryString)
{
    ...
    if(mysql_real_connect(mysql, "127.0.0.1", "connorter", "123456", "mysqlCgiTest", 3306, nullptr, 0) == nullptr)
    {
...
int main()
{
    ...
    int fd = open("/home/zs/project/http_project/out/wwwroot/calculator.html", O_RDONLY);
    if(fd == -1)
    {
